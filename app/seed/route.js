...
//       VALUES (${company.name}, ${company.logo_url}, ${company.website})
//       ON CONFLICT (name) DO UPDATE SET logo_url = EXCLUDED.logo_url, website = EXCLUDED.website
//       RETURNING id, name;
//     `;
...
//       id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
//       title_id UUID REFERENCES job_titles(id),
...
//     await sql`DROP TABLE IF EXISTS users, companies, job_categories, job_tags, job_titles, jobs, job_tag_mappings CASCADE`;
